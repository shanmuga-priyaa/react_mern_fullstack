...
const login = async()=>{
  ...
  await fetch("http://localhost:4000/login",{
    ...
    if(responseData.success){
      ...
      alert(responseData.errors || "Wrong password"?"Wrong password":"Login with  already existing account");
    }
}
const signup = async()=>{
  ...
  await fetch("http://localhost:4000/signup",{
    ...
    if(responseData.success){
      ...
      alert(responseData.errors || "Sign up with  already existing account");
    }
}
  return (
